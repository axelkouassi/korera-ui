    ...
    <div>
      <Container fluid>
        ...
        <Form noValidate validated={validated} onSubmit={handleSubmit}>
          <Form.Group class="form-floating" controlId="formBasicFirstName">
          ...
          <br />
          <Form.Group class="form-floating" controlId="formBasicLastName">
          ...
          <br />
          <Form.Group class="form-floating" controlId="formBasicEmail">
          ...
          <Form.Group class="form-floating" controlId="formBasicMobileNumber">
